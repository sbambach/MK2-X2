...
#define STRING_CONFIG_H_AUTHOR "(SB, MK2-X2)" // Who made the changes.
...
#define MACHINE_UUID "fb7299ab-1616-406d-9bcd-f6dc918c7578"
...
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 15, 10 } // TMC2100
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 2 + 32)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT ((Y_MIN_POS + Y_MAX_POS) / 2 + 1)    // Y point for Z homing when homing all axis (G28).
#endif
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { X_MAX_POS+10, Y_MIN_POS+10, (Z_MIN_POS + 1)}
  #define NOZZLE_CLEAN_END_POINT   { X_MAX_POS+10, Y_MIN_POS+60, (Z_MIN_POS + 1)}
